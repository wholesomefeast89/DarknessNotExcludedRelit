...
namespace DarknessNotIncluded
{
    ...
    public class Config
  {
    ...
    [Option("Enable Custom Light Shapes", "If disabled, only vanilla light shapes will be used. Disable if encountering issues with other lighting mods.", "Lighting")]
    public bool enableCustomLightShapes { get; set; } = true;
